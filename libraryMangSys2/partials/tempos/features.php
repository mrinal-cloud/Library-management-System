...
<meta name="theme-color" content="#712cf9">
    ...
    <style>
      ...
      body{
        ...
        color: rgba(107, 204, 206, 0.43);
      }


      .container {
        background-color: rgba(216, 204, 159, 0.078);
      }

      .container p{
        color: rgba(207, 171, 40, 0.511);
      }

      #featured-3 p{
        color: rgba(157, 207, 40, 0.404);
      }
...
<main>
  <h1 class="yes class"style=margin-left:200px;margin-top:80px;margin-bottom:30px;>The Features</h1>
  <!-- visually-hidden -->
